...
namespace OnlineShop.Areas.Admin.Controllers
{
    ...
    public class ProductTypesController : Controller
    {
        ...
        {
            var data = _db.ProductTypes.ToList().Where(x=>x.IsActive==true && x.IsDeleted==false);
        ...
        public async Task<IActionResult> Create(ProductTypes productTypes)
        {
            ...
            {
                productTypes.IsActive = true;
                productTypes.IsDeleted = false;
        ...
        public async Task<IActionResult> Delete(int? id, ProductTypes productTypes)
        {
            ...
            if (ModelState.IsValid)
            {
                productTypes.IsActive = false;
                productTypes.IsDeleted = true;
                await _dapper.UpdateAsync<ProductTypes>(productTypes);
